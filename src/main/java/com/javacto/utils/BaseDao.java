...
public class BaseDao {
  ...
  /*  private  static  String driverNameSbq="com.mysql.jdbc.Driver";
    private  static  String urlSbq="jdbc:mysql://127.0.0.1:3306/mysql0304?useUnicode=true&characterEncoding=utf-8";
    private  static  String userNameSbq="root";
    private  static  String pwdSbq="123";*/
